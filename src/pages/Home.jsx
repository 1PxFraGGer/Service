...
<section className="py-24 bg-white">
  <div className="container mx-auto px-6">
    ...
    <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      {[
        { name: "Home Cleaning", image: "/images/homecleaning1.jpg" },
        { name: "AC Services", image: "/images/ac1.jpg" },
        { name: "Plumbing", image: "/images/plumbing1.jpg" },
        { name: "Electrical", image: "/images/electric1.jpg" },
        { name: "Appliance Repair", image: "/images/appliance.jpg" },
        { name: "Painting", image: "/images/painting.jpg" },
        { name: "Pest Control", image: "/images/pest.jpg" },
        { name: "Salon at Home", image: "/images/salon.jpg" },
      ].map((category, index) => (
        <Link
          key={index}
          to="/services"
